...
public class MypageController {
	...
	/*
	 * @GetMapping("/list") public String join(@RequestParam String userId, Model
	 * model) {
	 * 
	 ...
	 * return "mypage/list"; }
	 * 
	 * @PostMapping("/list") public String updateUserInfo(@RequestParam Map<String,
	 * Object> userInfo, Model model) {
	 * 
